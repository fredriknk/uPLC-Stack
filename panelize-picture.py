...
tabs = { #Add tabs between board and board as well as board and rail
		"type":"none", #Place them with constant width and spacing 
  		"vcount": 2, 
    	"hcount": 2,
		"vwidth": "2.7mm",
	}
...
area1 = panel.appendBoard(board1_path, panelOrigin + placer.position(0,0, None) ,rotationAngle=270*deg, origin=Origin.Center, sourceArea=sourceArea1, netRenamer=netRenamer, refRenamer=refRenamer)
area2 = panel.appendBoard(board2_path, panelOrigin + placer.position(0,1, area1),rotationAngle=270*deg, origin=Origin.Center, sourceArea=sourceArea2, netRenamer=netRenamer, refRenamer=refRenamer,  inheritDrc=False)
area3 = panel.appendBoard(board3_path, panelOrigin + placer.position(0,2, area2),rotationAngle=270*deg, origin=Origin.Center, sourceArea=sourceArea3, netRenamer=netRenamer, refRenamer=refRenamer,  inheritDrc=False)
