...
The primary purpose of the uPLC is to "smartify" devices by integrating them with **ESPHome**. It can also function as a direct, point-to-point PLC, using **ESP-NOW** for wireless communication, replacing traditional wired connections.
...
### Coming Soon:
- **uPLC-COMM:** SPI, I2C, SDI12 support
